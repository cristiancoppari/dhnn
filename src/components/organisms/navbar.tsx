...
export default function Navbar() {
    return (
        <header className="grid w-full grid-cols-12 justify-center gap-6 2xl:px-[7.5rem]">
            <div className="col-span-full mb-0 flex h-[3.75rem] w-full justify-between border-b border-[var(--gray-light)] 2xl:h-[5.5rem]">
